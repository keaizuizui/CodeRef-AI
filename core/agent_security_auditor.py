...
GO_PATTERNS = [
    ...
    # （chatwiki internal/.../html.go:68 http.Get(src)、process_page.go:670
...
NODE_PATTERNS = [
    ...
    # （chatwiki subsection-box.vue / templates/detail.vue / message-item.vue 盲区）
    ...
    # （chatwiki useOpenUrlWithToken.js:36 盲区）
...
DESERIALIZATION_PATTERNS = [
    ...
    # 单行参数含 knowledge_graph 字样，但 aichatwiki retrieval.py:47 是
